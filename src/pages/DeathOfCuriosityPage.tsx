    ...
    <>
      ...
      <main className={styles.main}>
        <article className={styles.article}>
          ...
          <ArticleHero
            img={heroImage}
            imgAlt="Curiosity and innovation in the workplace"
            layout="below"
          ...
          <div className={styles.container}>
            <ArticleStatRow>
              <ArticleStat value="SXSW" label="sold-out talk" note="2019" />
              <ArticleStat value="3" label="ways culture kills curiosity" note="each one predictable" />
              <ArticleStat value="30:1" label="days acting vs. discovering" note="the research ratio problem" />
            </ArticleStatRow>
          </div>
          ...
          <div className={styles.container}>
            <ArticleTimeline>
              <ArticleTimelineItem step="01" heading="Reject Vulnerability" continueLine>
              ...
              <ArticleTimelineItem step="02" heading="Own the Answer, Not the Question" continueLine>
                <p className={styles.p}>
              ...
              <ArticleTimelineItem step="03" heading="Be a Fire Department">
                <p className={styles.p}>
          ...
          {/* ── Callout ── */}
          <div className={styles.container}>
            <ArticleCallout label="The Underlying Pattern" variant="insight">
              <p>While companies say they are invested in innovation, what they typically mean is innovation that takes no time, requires no tough conversations, and reinforces that they are doing everything right already. What they typically need isn't a scientist — it's a skilled therapist, to help them begin to embrace change and curiosity.</p>
            </ArticleCallout>
          </div>
